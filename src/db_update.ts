...
// NEW ITEM FUNCTIONS //
////////////////////////
export const addFileToSyncTable = (file: core.ArFSFileMetaData) => {
	const {
		login,
		appName,
		appVersion,
...
export const addDriveToDriveTable = (drive: core.ArFSDriveMetaData) => {
	const {
		login,
		appName,
		appVersion,
...
export const createArDriveProfile = (user: core.ArDriveUser) => {
	return run(
